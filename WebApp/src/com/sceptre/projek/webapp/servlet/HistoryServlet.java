    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (access_token != null) {
            ...
            if (orderWS != null) {
                ...
                String JSONResponse = orderWS.getCustomerOrders(access_token, userAgent, ipAddress);
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (access_token != null) {
            ...
            if (orderWS != null) {
                ...
                String JSONResponse = orderWS.hideCustomer(access_token, userAgent, ipAddress, orderId);
                JSONObject jsonObject = new JSONObject(JSONResponse);
                int authResult = WSClient.checkAuth(request, response, jsonObject);
                if (authResult == WSClient.AUTH_RETRY) {
